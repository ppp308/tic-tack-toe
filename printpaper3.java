...
public class printpaper1 {
	...
	public static void main(String[] args) {
		...
		String[] k11_itemname = { "해피홈SAFE365핸드폰클리너", "(G)LH원형유리화병10", "상투과자E", "더블링나일론깡롤", "해피홈SAFE핸드워시",
				...
				"녹차원흑당시럽10입", "진라면소컵(매)65g*6", "케라시스앰플트리트", "푸르밀미숫가루우유", "자일로스갈색설탕500g", "CJ 비비고칩 20G", "피코크들깨미역국500g",
				"흑원당말차밀크티", "1+등급란10개입 특", "동원양반볶음김치기획", "바나나", "초코파이", "포도","맛없는 자이로스 ()100그램a++" };
		// 품목 변수 선언
