...
public class printrpaper {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < k11_itemname1.length(); i++) {
			// 품목명으로 선언한 변수 길이만큼 출력
			// 0~29
			if (i >= 7) {
				// 각 품목명의 길이가 7보다 클때
				k11_itemname1 = k11_itemname1.substring(0, 5);
				// 각 품목명의 5까지 가져옴
			} else {

			}

			int num = 10 -  k11_itemname1.getBytes().length;
			// 만약에 품목명이 모두 한글로 차있다면 5*2=10
			// 10 - 품목명길이의 바이트
			// 6길이 글자 - 실제 글자 길이 = 공백
			for (int j = 0; j < num; j++) {
				 k11_itemname1 =  k11_itemname1 + " ";
				// 공백의 길이만큼 글자+공백을 만듬
			}
		}
		System.out.printf("%s  %9s %8s %10s\n", k11_itemname1, sb.format(k11_price1), sb.format(k11_amount1),
				sb.format(k11_price1));
		//품목의 길이가 15까지 나올 수 있게 출력하고, 숫자의 띄어쓰기를 맞춤
		System.out.printf("[%s]\n", k11_itemcode1);
		//코드 출력
		for (int i = 0; i < k11_itemname2.length(); i++) {
			// 품목명으로 선언한 변수 길이만큼 출력
			// 0~29
			if (i >= 7) {
				// 각 품목명의 길이가 7보다 클때
				k11_itemname2 = k11_itemname2.substring(0, 5);
				// 각 품목명의 5까지 가져옴
			} else {

			}

			int num = 10 -  k11_itemname2.getBytes().length;
			// 만약에 품목명이 모두 한글로 차있다면 5*2=10
						// 10 - 품목명길이의 바이트
						// 6길이 글자 - 실제 글자 길이 = 공백
			for (int j = 0; j < num; j++) {
				 k11_itemname2 =  k11_itemname2 + " ";
				// 공백의 길이만큼 글자+공백을 만듬
			}
		}
		...
		System.out.printf("[%s]\n", k11_itemcode2);
		//코드 출력
		for (int i = 0; i < k11_itemname3.length(); i++) {
			// 품목명으로 선언한 변수 길이만큼 출력
			// 0~29
			if (i >= 7) {
				// 각 품목명의 길이가 7보다 클때
				k11_itemname3 = k11_itemname3.substring(0, 5);
				// 각 품목명의 5까지 가져옴
			} else {

			}

			int num = 10 -  k11_itemname3.getBytes().length;
			// 만약에 품목명이 모두 한글로 차있다면 5*2=10
						// 10 - 품목명길이의 바이트
						// 6길이 글자 - 실제 글자 길이 = 공백
			for (int j = 0; j < num; j++) {
				 k11_itemname3 =  k11_itemname3 + " ";
				// 공백의 길이만큼 글자+공백을 만듬
			}
		}
		...
		System.out.printf("        llIllllIllllIllllIlllll\n");
		//바코드는 제대로 출력하지 못함..
		System.out.printf("         2112820610158231\n");
		System.out.printf("----------------------------------------\n");
		System.out.printf("◈다이소 멤버십 앱 또는 홈페이지에 접속하셔서 회원가입후 다양한 혜택을 누려보세요!◈\n");
